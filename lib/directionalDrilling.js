...
var DirectionalDrilling = /** @class */ (function () {
  ...
  DirectionalDrilling.prototype.horizontal_Displacement = function (value, kickoffPoint, trueVerticalDepth) {
    ...
    var angleX = (value - this.build_UpAngle(this._buildUpAngle)) / (this._trueVerticalDepth - this._kickOffPoint);
  ...
  DirectionalDrilling.prototype.measured_DepthAtEndOfBuildSection = function (kickoffPoint) {
    this._kickOffPoint = kickoffPoint;
    var setMeasuredDepth =
      (this.total_AngleXplusY() * this.valuetimesTotalAngleXplusY * Math.PI * this.build_UpAngle(this._buildUpAngle)) /
        this.valueDividebyBuildUpAngle +
      kickoffPoint;
    return setMeasuredDepth;
  };
  DirectionalDrilling.prototype.trueVertical_DepthAtEndOfBuild = function (KickOffPoint) {
    this._kickOffPoint = KickOffPoint;
    var trueVerticalDepthCompute =
      this.build_UpAngle(this._buildUpAngle) * Math.sin(this.toRadians(this.total_AngleXplusY())) + KickOffPoint;
