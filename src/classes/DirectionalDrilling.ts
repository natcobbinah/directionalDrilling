import { DirectionDrillingClassTemplate, InitalizeDrillingData } from "../interfaces/IDirectionalDrillingTemplate";
import { drillingConstants } from "../constants/constants";
